...
export const managerList = (current, size, params) => {
  return request({
    url: '/api/memo-flow/manager/list',
    method: 'get',
    params: {
      ...params,
      current,
...
export const removeModel = (ids) => {
  return request({
    url: '/api/memo-flow/model/remove',
    method: 'post',
    params: {
      ids,
    }
...
export const deployModel = (params) => {
  return request({
    url: '/api/memo-flow/model/deploy',
    method: 'post',
    params
  })
}
...
export const changeState = (params) => {
  return request({
    url: '/api/memo-flow/manager/change-state',
    method: 'post',
    params
  })
}
...
export const deployUpload = (category, tenantIds, files) => {
  ...
  return request({
    ...
    url: '/api/memo-flow/manager/deploy-upload',
    method: 'post',
    data: formData
  })
}
...
export const deleteDeployment = (deploymentIds) => {
  return request({
    url: '/api/memo-flow/manager/delete-deployment',
    method: 'post',
    params: {
      deploymentIds,
    }
...
export const deleteProcessInstance = (params) => {
  return request({
    url: '/api/memo-flow/follow/delete-process-instance',
    method: 'post',
    params
  })
}
