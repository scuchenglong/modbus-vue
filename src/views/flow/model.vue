<template>
  <basic-container>
    ...
    <el-dialog title="流程配置" id="flowbuild"
               append-to-body
          ...
          column: [
            {
              label: "流程类型",
              type: "select",
              dicUrl: "/api/memo-system/dict/dictionary?code=flow",
              props: {
                label: "dictValue",
                value: "dictKey"
              },
            ...
            },
            {
              ...
              type: "tree",
              multiple: true,
              dicUrl: "/api/memo-system/tenant/select",
              props: {
                label: "tenantName",
                value: "tenantId"
              },
...
<style>
  ...
  #flowbuild .el-dialog__header{
    display:none1;
    position:absolute;
    right:5px;
  }
  #flowbuild .el-dialog__title{
    display:none;
  }
  #flowbuild .el-dialog__body{
    padding:5px;
  }
