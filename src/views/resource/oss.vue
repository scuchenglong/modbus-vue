...
<script>
  ...
  export default {
          ...
          column: [
            {
              ...
              searchLabelWidth: 50,
              row: true,
              dicUrl: "/api/memo-system/dict/dictionary?code=oss",
              props: {
                label: "dictValue",
                value: "dictKey"
              },
        ...
        debugOption: {
          ...
          column: [
            ...
            },
            {
              ...
              action: '/api/memo-resource/oss/endpoint/put-file',
              propsHttp: {
                res: 'data',
                url: 'link',
              },
    ...
    watch: {
      ...
      'debugForm.code'() {
        this.debugOption.column[1].action = `/api/memo-resource/oss/endpoint/put-file?code=${this.debugForm.code}`;
      }
    },
    computed: {
